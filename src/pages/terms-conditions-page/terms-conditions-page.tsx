...
type Props = {};
const TermsConditionsPage: React.SFC<Props> = () => {
  return (
    <DefaultLayout>
      <Heading sectionTitle>Terms &amp; Conditions</Heading>
      <Content>
        <h2>
          <strong>Terms and Conditions</strong>
        </h2>

        <p>Welcome to Spot-movie.com!</p>

        <p>
          These terms and conditions outline the rules and regulations for the
          use of www.spot-movie.com's Website, located at
          http://www.spot-movie.com.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Spot-movie.com if you do not agree
        ...
        <p>
          We employ the use of cookies. By accessing Spot-movie.com, you agreed
          to use cookies in agreement with the www.spot-movie.com's Privacy
          Policy.
        </p>
        ...
        <p>
          Unless otherwise stated, www.spot-movie.com and/or its licensors own
          the intellectual property rights for all material on Spot-movie.com.
          All intellectual property rights are reserved. You may access this
          from Spot-movie.com for your own personal use subjected to
          restrictions set in these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from Spot-movie.com</li>
          <li>Sell, rent or sub-license material from Spot-movie.com</li>
          <li>Reproduce, duplicate or copy material from Spot-movie.com</li>
          <li>Redistribute content from Spot-movie.com</li>
        </ul>
        ...
        <p>
          ...
          www.spot-movie.com does not filter, edit, publish or review Comments
          prior to their presence on the website. Comments do not reflect the
          views and opinions of www.spot-movie.com,its agents and/or affiliates.
          ...
          www.spot-movie.com shall not be liable for the Comments or for any
        ...
        <p>
          www.spot-movie.com reserves the right to monitor all Comments and to
        ...
        <p>
          You hereby grant www.spot-movie.com a non-exclusive license to use,
        ...
        <p>
          ...
          the hyperlink compensates the absence of www.spot-movie.com; and (d)
        ...
        <p>
          ...
          sending an e-mail to www.spot-movie.com. Please include your name,
        ...
        <p>
          No use of www.spot-movie.com's logo or other artwork will be allowed
