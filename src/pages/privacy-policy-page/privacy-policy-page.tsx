...
type Props = {};
const PrivacyPolicyPage: React.SFC<Props> = () => {
  return (
    <DefaultLayout>
      <Content>
        ...
        <p>
          Spot-movie operates the http://www.spot-movie.com website (the
          "Service").
        </p>
        ...
        <p>
          ...
          our Terms and Conditions, accessible from http://www.spot-movie.com
        </p>
        ...
        <p>Spot-movie uses the collected data for various purposes:</p>
        <ul>
        ...
        <p>
          Spot-movie will take all steps reasonably necessary to ensure that
        ...
        <p>
          Spot-movie may disclose your Personal Data in the good faith belief
          that such action is necessary to:
        </p>
        <ul>
          <li>To comply with a legal obligation</li>
          <li>To protect and defend the rights or property of Spot-movie</li>
          <li>
        ...
        <ul>
          <li>By email: help@spot-movie.com</li>
        </ul>
      </Content>
    </DefaultLayout>
  );
